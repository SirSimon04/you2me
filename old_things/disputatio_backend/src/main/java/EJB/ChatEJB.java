...
//            letzteN.setNutzerList(null);
    ...
    /**
     * Diese Methode gibt alle Chats, die ein Nutzer archiviert hat, zurück.
     *
     * @param self Der Nutzer, dessen Chats angefragt werden.
     * @return Eine Liste mit allen archivierten Chats
     */
    public List<Chat> getArchived(Nutzer self){
        List<Chat> list = self.getArchivedChats();
        return list;
    }
     ...
     * @return Der gerade erstellte Chat, um auf die automatisch generierte Id zuzugreifen.
     */
    public Chat createChat(Chat neuerChat){
