...
CREATE TABLE NUTZER (ID INTEGER NOT NULL GENERATED ALWAYS AS IDENTITY(START WITH 1, INCREMENT BY 1), BENUTZERNAME VARCHAR(50) NOT NULL, VORNAME VARCHAR(50), NACHNAME VARCHAR(50), EMAIL VARCHAR(50) NOT NULL, PASSWORDHASH VARCHAR(255) NOT NULL, HANDYNUMMER VARCHAR(50), PROFILBILD INTEGER, INFO VARCHAR(256), ISADMIN BOOLEAN, VERIFICATIONPIN INTEGER, LASTONLINE BIGINT, ISONLINE BOOLEAN, MITGLIEDSEIT INTEGER, PRIMARY KEY (ID), foreign key(profilbild) references Foto(id));
